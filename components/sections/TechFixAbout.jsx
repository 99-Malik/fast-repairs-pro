          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-body text-gray-600">
                With over 15 years of experience in the UAE, TechFix Solutions has become the leading 
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Founded in 2008, TechFix Solutions started as a small family business with a simple mission: 
