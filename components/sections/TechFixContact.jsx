      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {contactMethods.map((method, index) => (
                <a
                  key={index}
                  href={method.action}
                  className="card-modern p-6 group hover:shadow-glow transition-all duration-300"
                >
            ...
            {/* Quick Contact */}
            <div className="card-modern p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
