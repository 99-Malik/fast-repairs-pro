...
const TechFixTestimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      location: 'Abu Dhabi',
      rating: 5,
      text: 'TechFix saved my washing machine! Same-day service and excellent quality. The technician was knowledgeable and friendly. Will definitely use again.',
    ...
    },
    {
      ...
      rating: 5,
      text: 'Amazing experience! The technician arrived on time and fixed my oven heating issue. Clean work and professional service. Thank you TechFix!',
      service: 'Oven Repair',
      date: '1 week ago',
      avatar: '👩‍🍳'
    },
        ...
        <div className="text-center mt-16">
          <div className="card-modern p-8 max-w-2xl mx-auto bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
            ...
            <p className="text-gray-700 mb-6">
              Join thousands of satisfied customers who trust TechFix Solutions for their appliance repair needs.
            </p>
